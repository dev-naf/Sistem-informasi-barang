...
let virtual-env = "/run/media/naf/Coding/Source Code/Python/PyQt/Project/SIPB"
let bin = "bin"
let path-sep = ":"
...
alias deactivate = source "/run/media/naf/Coding/Source Code/Python/PyQt/Project/SIPB/bin/deactivate.nu"
